...
# ║                        AUTO-GENERATED FILE                               ║
# ║                                                                           ║
# ║  Generated by: goobits-cli v1.0.3                     ║
# ║  Generated from:                                          ║
# ║                                                                           ║
...
install_with_pip() {
    ...
    if [[ "$install_dev" == "true" ]]; then
        ...
        (cd "$PROJECT_DIR" && python3 -m pip install --editable "$DEVELOPMENT_PATH[local]" $PIP_USER_FLAG) &
        show_spinner $!
        wait $!
        local exit_code=$?
        ...
        python3 -m pip install "$PYPI_NAME[local]" $PIP_USER_FLAG &
        show_spinner $!
        wait $!
        local exit_code=$?
...
upgrade_package() {
    ...
    if [[ "$PIPX_AVAILABLE" == "true" ]]; then
        ...
        python3 -m pip install --upgrade "$PYPI_NAME[local]" $PIP_USER_FLAG >/dev/null 2>&1 &
        show_spinner $!
        wait $!
        local exit_code=$?
    fi
...
show_install_success_message() {
    echo
    echo "Matilda Brain has been installed successfully!
...
show_dev_success_message() {
    echo
    echo "Matilda Brain has been installed in development mode!
...
show_upgrade_success_message() {
    echo
    echo "Matilda Brain has been upgraded successfully!
...
show_uninstall_success_message() {
    echo
    echo "Matilda Brain has been uninstalled.
